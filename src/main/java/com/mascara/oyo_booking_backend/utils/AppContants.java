...
//    public static final String FACILITY_CATEGORY_NOT_FOUND = "Facility category not found";
//    public static final String ACCOM_CATEGORY_NOT_FOUND = "Accom Category not found";
