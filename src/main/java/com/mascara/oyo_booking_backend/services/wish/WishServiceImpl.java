...
public class WishServiceImpl implements WishService {
    ...
    public BaseMessageData<Boolean> checkAccomPlaceIsWishOfUser(Long accomId, String mailUser) {
        User user = userRepository.findByMail(mailUser).orElseThrow(() -> new ResourceNotFoundException(MessageConstant.NOT_FOUND_MESSAGE("User")));
    ...
    public BaseMessageData<String> handleWishItemOfUser(Long accomId, String mailUser) {
        ...
        if (!wishItemOptional.isPresent()) {
            ...
            return new BaseMessageData<>(MessageConstant.ADD_WISH_ITEM_SUCCESS);
        }
        ...
        return new BaseMessageData<>(MessageConstant.REMOVE_WISH_ITEM_SUCCESS);
    }
    ...
    public BasePagingData<GetAccomPlaceResponse> getListWishItemOfUser(Integer pageNum,
                                                                       ...
                                                                       String field,
                                                                       String userMail) {
        User user = userRepository.findByMail(userMail).orElseThrow(() -> new ResourceNotFoundException(MessageConstant.NOT_FOUND_MESSAGE("User")));
